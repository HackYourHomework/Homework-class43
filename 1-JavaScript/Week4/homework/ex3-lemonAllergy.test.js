...
// ! Function under test
function sanitizeFruitBasket(array, dangerFruit) {
  const newArray = array.filter(fruit => fruit !== dangerFruit)
  return newArray
}
...
describe('sanitizeFruitBasket', () => {
  ...
  test('should not modify the original `fruitBasket` array', () => {
    ...
    expect(actual).toStrictEqual(originalFruitBasketContents);
  });

  test('should return a new array that does not include the unwanted `lemon`', () => {
    // TODO replace next line with your code
    const newArr = sanitizeFruitBasket(fruitBasket, 'lemon');
