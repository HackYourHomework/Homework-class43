...
/*
callback version:
   In the main() function, we are checking if there is an error (by looking null or not), and for the final value because we are sending null and a value, it always prints Success message with the final value at the end.
promise version:
   We are just checking resolve or reject that's why we don't get the last line when the promise rejected.
