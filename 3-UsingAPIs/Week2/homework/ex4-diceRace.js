...
/*
 The answer:
  This happens because of how Promise.race() method function, it takes an 
  array of promises and return a promies that resolve once a one of those 
  give promises resolve, so instead of waiting all the promises to resolve 
  as what Promise.all() method does, it takes the fastest one and resolve
  it, means that we still have another promises that did not resovle yet
  <Excatly as the promises have an actual race>
*/
